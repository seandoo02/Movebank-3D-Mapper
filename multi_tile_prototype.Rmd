...
```{r}
for(i in 1:length(test_col_list)){
  plot.new()
  # Draw a rectangle from the bottom left (0,0) to the top right (1,1)
  rect(0, 0, 1, 1, col = test_col_list[[i]], border = NA)
}
```
...
df_individual=df[df$individual.local.identifier==inividuals[index_list[[4]]],]
